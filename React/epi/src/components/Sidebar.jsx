        ...
        <li className="nav-item">
          ...
          <div className="collapse" id="minhasVestimentas">
            <ul className="nav flex-column sub-menu">  
              <li className="nav-item">
                <a className="nav-link" data-toggle="collapse" id="minhasVestimentas" href="#minhasInformacoes" aria-expanded="false" aria-controls="minhasInformacoes">
                  <i className="typcn typcn-user menu-icon"></i>
                    <span className="menu-title">Informações</span>
                  <i className="menu-arrow"></i>
                </a>     
                <div className="collapse" id="minhasInformacoes">        
                  <ul className="nav flex-column sub-menu">
                    <li className="nav-item"> <Link to={`/`} className="nav-link" onClick={e => {Session.setParam("")}}>Minhas Vestimentas</Link></li>
                  </ul>
                </div>
                <li className="nav-item">
