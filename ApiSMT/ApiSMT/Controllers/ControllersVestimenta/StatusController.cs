...
namespace ApiSMT.Controllers.ControllersVestimenta
{
    ...
    public class StatusController : ControllerBase
    {
        ...
        public StatusController(IStatusVestBLL statusVest)
        {
        ...
        /// <returns></returns>
        [HttpGet("{id}")]
        public async Task<ActionResult<VestimentaDTO>> getStatus(int id)
        {
            try
            {
                if (id != 0)
        ...
        ///// <returns></returns>
        //[HttpGet("teste/{teste}")]
        //public async Task<ActionResult> teste(string teste)
        //{
        //    try
        //    {
        //        return Ok(new { message = "Ta funcionando" });
        //    }
        //    catch (Exception ex)
        //    {
        //        return BadRequest(ex.Message);
